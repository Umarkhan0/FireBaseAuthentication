...
// // createUserWithEmailAndPassword(auth, 'uk4834877@gmail.com', "123456")
// //   .then((userCredential) => {
...
// /*signInWithEmailAndPassword(auth, 'umaraamir959@gmail.com', "123456")
//   .then((userCredential) => {
//     // Signed in 
//     const user = userCredential.user;
//         console.log(user)
...
let oneCall = ()=>{
  ...
  <div class="white-container">
              ...
              <div class="Input-container">
                  <input class="user-input log-name-icon" type="text" placeholder="Enter your name">
                  <input class="user-input email-icon" type="email" placeholder="Enter your Email">
                  <input class="user-input input-key" type="password" placeholder="Enter your password">
              </div>
...
<div class="white-container">
            ...
            <div class="Input-container">
                <input class="user-input email-icon" type="email" placeholder="Enter your email" required>
                <input class="user-input input-key" type="password" placeholder="Enter your Password" required>
                <input class="user-input input-key" type="password" placeholder="ReEnter your password" required>
            </div>
